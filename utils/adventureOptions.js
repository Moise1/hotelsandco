...
export const adventureOptions = [
    ...
    {
      icon: <Icon icon="ic:outline-house-siding" width="24" height="24"/>,
      text: "Cabins",
    },
    {
    ...
    {
      icon: <Icon icon="icon-park-outline:green-house" width="30" height="30" />,
      text: "Mansions",
    },
    {
      icon: <Icon icon="game-icons:bird-house" width="24" height="24" />,
      text: "Designs",
    },
  ];